...
class LinkedListTest {
    ...
    LinkedList <Integer> testListInteger;
    LinkedList <Double> testListDouble;
    LinkedList <String> testListString;
    LinkedList <Boolean> testListBool;

    @BeforeEach
    void setUp(){
        testListInteger = new LinkedList<>();
        testListString = new LinkedList<>();
        testListBool =new LinkedList<>();
        testListDouble = new LinkedList<>();
    ...
    void appendToList() {
        ...
        LinkedList <Integer> testEmptyListInt = new LinkedList<>();
        LinkedList <Boolean> testEmptyListBool = new LinkedList<>();
        LinkedList <String> testEmptyListString = new LinkedList<>();
        LinkedList <Double> testEmptyListDouble = new LinkedList<>();
